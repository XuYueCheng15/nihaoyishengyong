...
- (void)prepare
{
    ...
    //自己写的
    self.lastUpdatedTimeLabel.font = [WorkOutWordsSize fontSize:12 isbold:NO];
    self.lastUpdatedTimeLabel.textColor = [UIColor colorWithHexString:@"333333"];
    
    self.stateLabel.font = [WorkOutWordsSize fontSize:12 isbold:NO];
