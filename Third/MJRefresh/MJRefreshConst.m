...
const CGFloat MJRefreshFooterHeight = 44.0;//开始是44.0
const CGFloat MJRefreshFastAnimationDuration = 0.25;//开始是0.25
const CGFloat MJRefreshSlowAnimationDuration = 0.4;//开始是0.4
